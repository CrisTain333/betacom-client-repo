...
import fireGif from "../../image/fire-joypixels.gif";
              ...
              <div>
                <h2 className=" font-sans text-3xl text-center font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none  flex items-center justify-center">
                  <img
                    src={fireGif}
                    alt=""
                    className="h-14 mr-2 hidden lg:flex"
                  />
                  Flash Deals For You
                  <img src={fireGif} alt="" className="h-14 hidden lg:flex" />
                </h2>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-end">
                          <p className="text-md dark:text-gray-400">
                            Price : <strong>${p.ResalePrice}</strong>
                          </p>
                          <p className="text-md text-gray-400 line-through ml-3">
                            {" "}
                            <strong>{p.originalPrice}</strong>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-wrap justify-between">
                      ...
                      <div className="flex space-x-2 text-sm dark:text-gray-400">
                        <p className="flex items-center p-1 space-x-1.5">
                          Used
                          <span className="ml-2">
                            <strong>{p.YearsOfUse} </strong>
                          </span>{" "}
                          Year
                        </p>
                      </div>
